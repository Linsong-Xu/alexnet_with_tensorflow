...
filewriter_path = './store/tensorboard'
...
with tf.device('/cpu:0'):
    ...
    tr_data = ImageDataGenerator(train_file, batch_size=batch_size, num_classes=num_classes, shuffle=False)
    
    val_data = ImageDataGenerator(val_file, batch_size=batch_size, num_classes=num_classes, shuffle=False)
